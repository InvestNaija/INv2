...
Calculator.compounding = (initial_amt = 0, PMT, frequency, interest_rate, start_date, end_date) => {
...
Calculator.plan = (initial_amt = 0, future_value, frequency, interest_rate, start_date, end_date) => {
...
Calculator.once = (PMT, frequency, interest_rate, start_date, end_date) => {
...
Calculator.initialize = (P, frequency, interest_rate, start_date, end_date) => {
    let t = Number(((0, moment_1.default)(end_date).diff(start_date, 'days') / 365).toFixed(2)); //tenure in years
    let n = Calculator.calculate_payment_frequency(frequency);
    const r = interest_rate / 100;
    return { P, t, n, r };
};
Calculator.calculate_payment_frequency = (frequency) => {
    let frequency_num = 1;
