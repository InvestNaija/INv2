...
exports.GenericSaveplanController = void 0;
...
let GenericSaveplanController = class GenericSaveplanController {
    ...
    grpc(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const profiler = common_1.INLogger.log.startTimer();
            try {
                const grpcClient = yield client_1.GrpcClient.start();
                const result = yield client_1.GrpcClient.initializePayment(grpcClient, req.body);
...
exports.GenericSaveplanController = GenericSaveplanController;
__decorate([
    (0, inversify_express_utils_1.httpGet)("/:type?"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", Promise)
], GenericSaveplanController.prototype, "list", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", Promise)
], GenericSaveplanController.prototype, "create", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], GenericSaveplanController.prototype, "update", null);
__decorate([
    (0, inversify_express_utils_1.httpPost)("/grpc/test"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", Promise)
], GenericSaveplanController.prototype, "grpc", null);
exports.GenericSaveplanController = GenericSaveplanController = __decorate([
    (0, inversify_express_utils_1.controller)("/saveplan"),
    __metadata("design:paramtypes", [services_1.AdminService])
], GenericSaveplanController);
