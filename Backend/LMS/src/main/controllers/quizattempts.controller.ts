...
export class QuizAttemptController {
   ...
   public static async startAttempt(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {      
         ...
         const quizAttempt = await QuizAttemptController.quizAttemptService.startAttempt(req.currentUser!, body);
   ...
   public static async endAttempt(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
         ...
         const endAttempt = await QuizAttemptController.quizAttemptService.endAttempt(req.currentUser!, data);
   ...
   public static async getAttempts(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
         ...
         const getAttempts = await QuizAttemptController.quizAttemptService.getAttempts(req.currentUser!, data);
   ...
   public static async deleteAttempt(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
         ...
         const deleteAttempt = await QuizAttemptController.quizAttemptService.deleteAttempt(req.currentUser!, data);
