...
import { LmsService, QuizQuestionService, QuestionAnswerService, QuizAttemptService, AttemptAnswerService } from './business/services';
...
container.bind(QuizAttemptService).toSelf();
