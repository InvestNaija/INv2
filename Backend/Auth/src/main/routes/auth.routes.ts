...
class AuthRoutes {
   ...
   public routes(): Router {
      ...
      this.router.post('/user/set-2FA', Authentication.requireAuth, AuthController.set2FA);
      this.router.post('/user/signout', Authentication.requireAuth, AuthController.set2FA);
