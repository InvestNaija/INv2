...
class Main {
    ...
    createEventBus() {
        return __awaiter(this, void 0, void 0, function* () {
            yield rabbitmq_wrapper_1.rabbitmqWrapper.connect('amqp://rabbitmq-srv');
            ...
            new listeners_1.UserCreatedListener(rabbitmq_wrapper_1.rabbitmqWrapper.connection).listen();
        });
    }
