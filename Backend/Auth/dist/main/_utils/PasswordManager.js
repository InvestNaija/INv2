...
class PasswordManager {
    static toHash(password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            password = (new crypto_2.Crypto({ aesKey: process.env.AES_SECRET_KEY, ivKey: process.env.IV_SECRET_KEY })).decryptWithKeyAndIV(password);
    ...
    static compare(storedPassword, suppliedPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const password = (new crypto_2.Crypto({ aesKey: process.env.AES_SECRET_KEY, ivKey: process.env.IV_SECRET_KEY })).decryptWithKeyAndIV(suppliedPassword);
