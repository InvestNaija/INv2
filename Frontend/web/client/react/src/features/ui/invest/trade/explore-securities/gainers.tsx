...
// Today's top-gaining securities, fetched live from the trades API
// (GET /trades/securities/performance?type=pg) — search and pagination
...
const Gainers = () => {
  ...
  useEffect(() => {
    const fetchGainers = async () => {
      setIsLoading(true);
      try {
        const response = await fetchSecuritiesPerformance("pg");
