...
interface RemoveWatchlistConfirmationProps {
  open: boolean;
...
const RemoveWatchlistConfirmation = (
  props: RemoveWatchlistConfirmationProps,
) => {
        ...
        <div className="mt-[8px]">
          <div className="flex justify-center">
            <div className="flex h-[64px] w-[64px] items-center justify-center rounded-[12px] bg-[#FFECDF]">
              <i className="ri-star-line text-[32px] text-[#CC1A30]"></i>
            </div>
          </div>
          ...
          <div className="text-center text-[16px] text-(--text-content-default) font-normal leading-[24px]">
            <span>
              ...
              {props.securityName || "this security"} from your watchlist?
            </span>
          </div>
...
export default RemoveWatchlistConfirmation;
